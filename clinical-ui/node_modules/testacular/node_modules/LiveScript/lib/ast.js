...
exports.Block = Block = (function(superclass){
  ...
  prototype.add = function(it){
    ...
    default:
      this.lines.push(it);
      if (that = it.showWardList, delete it.showWardList, that) {
        this.showWardList = that;
      }
    }
    return this;
  };
...
exports.Call = Call = (function(superclass){
  ...
  Call.showWardList = function(params, node, bound, curried){
    ...
    return node.showWardList = (args[index] = fun).body, node;
  };
