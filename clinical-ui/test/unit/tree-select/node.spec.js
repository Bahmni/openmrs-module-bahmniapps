...
describe("Bahmni.Opd.TreeSelect.Node", function () {
    ...
    describe("isSelectable", function () {
        it('should be true when conceptClass is LabSet', function() {
            var node_null_set = new Node({display: "default concept", conceptClass: {display: "LabSet"}});
            var node_true_set = new Node({display: "default concept", set: true, conceptClass: {display: "LabSet"}});
        ...
        it('should be true when conceptClass is not a set', function() {
            var node_false_set = new Node({display: "default concept", set: false, conceptClass: {display: "Misc"}});
            var node_null_set = new Node({display: "default concept", set: null, conceptClass: {display: "Misc"}});
            var node_missing_set = new Node({display: "default concept", conceptClass: {display: "Misc"}});
        ...
        it('should be false when it is a set', function() {
            var node = new Node({display: "default concept", set: true, conceptClass: {display: "Misc"}});
    ...
    describe("shouldBeShown", function () {
        it('should be true when node is not a set', function() {
            var node = new Node({display: "default concept", set: false, conceptClass: {display: "Misc"}});

            expect(node.shouldBeShown()).toBeTruthy();
        });

        it('should be true when node is a set and has children', function() {
            var node = new Node({display: "default concept", set: true, conceptClass: {display: "Misc"}}, [new Node({})]);
    ...
    describe("toggleSelection", function () {
        it('should select a node', function() {
            var node = new Node({display: "default concept", conceptClass: {display: "Misc"}});
        ...
        it('should select its children and disable them', function() {
            var child1 = new Node({display: "child concept 1", conceptClass: {display: "Misc"}});
            var child2 = new Node({display: "child concept 2", conceptClass: {display: "Misc"}});
            var node = new Node({display: "default concept", set: true, conceptClass: {display: "LabSet"}}, [child1, child2]);
