...
angular.module('orders', ['ngRoute', 'orders.pending', 'bahmni.common.infrastructure','authentication', 'bahmni.common.appFramework', 'httpErrorInterceptor','bahmni.common.patient', 'bahmni.common']);
