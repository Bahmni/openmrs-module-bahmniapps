...
angular.module('orders', ['ngRoute', 'orders.pending', 'bahmni.common.domain','authentication', 'bahmni.common.appFramework', 'httpErrorInterceptor','bahmni.common.patient']);
