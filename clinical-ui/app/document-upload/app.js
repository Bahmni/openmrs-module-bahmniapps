...
angular.module('documentupload').config(['$routeProvider', '$httpProvider', function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when('/patient/:patientUuid/document', {templateUrl: 'modules/document-upload/views/documentUpload.html', controller: 'DocumentController', resolve: {initialization: 'initialization'}});
