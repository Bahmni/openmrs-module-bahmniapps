...
angular.module('opd', ['navigation.navigationController','opd.diagnosisController','opd.treatmentController','opd.investigationController', 'opd.activePatientsListController', 'opd.treeSelect'])
angular.module('opd').config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.when('/patient/:patientUuid/investigation', {templateUrl: 'modules/opd/views/investigations.html', controller: 'InvestigationController'});
