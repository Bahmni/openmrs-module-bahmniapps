...
angular.module('opd').config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.when(Bahmni.Opd.Constants.activePatientsListUrl , { templateUrl: 'modules/patient/views/activePatientsList.html', controller: 'ActivePatientsListController'});
