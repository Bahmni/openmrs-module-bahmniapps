...
angular.module('consultation', ['opd.consultation','opd.bedManagement', 'bahmni.common.infrastructure', 'bahmni.common.patient', 'opd.conceptSet', 'authentication', 'appFramework']);
angular.module('consultation').config(['$routeProvider', '$httpProvider', function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when('/visit/:visitUuid/concept-set/:conceptSetName', {templateUrl: 'modules/concept-set/views/conceptSetView.html',resolve: {initialization: 'initialization'}});
