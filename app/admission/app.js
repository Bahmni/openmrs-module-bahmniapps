...
angular.module('admission').config(['$routeProvider', function ($routeProvider) {
   ...
   // 	$routeProvider.when("/visit/:visitUuid", { templateUrl: 'modules/admission/views/admissionForm.html',  controller: 'AdmissionController', resolve: {initialization:'initialization'} });
	}]);