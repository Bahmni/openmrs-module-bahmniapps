...
angular.module('opd').config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.when(constants.activePatientsListUrl + "/:location", {templateUrl: 'modules/opd/views/activePatientsList.html', controller: 'ActivePatientsListController'});
