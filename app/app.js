...
angular.module('registration', ['registration.search', 'registration.session', 'registration.navigation', 'http-auth-interceptor', 'registration.createPatient', 'registration.visitController', 'infrastructure', 'infrastructure.httpErrorInterceptor','registration.patientCommon', 'registration.editPatient'])
