...
angular.module('bahmni.registration')
    .directive('patientCommon', ['$rootScope', '$http', 'patientAttributeService', 'addressAttributeService', 'appService',
        function ($rootScope, $http, patientAttributeService, addressAttributeService, appService) {
            ...
            return {
                restrict: 'E',
                templateUrl: 'views/patientCommon.html',
