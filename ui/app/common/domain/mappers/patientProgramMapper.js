...
Bahmni.Common.Domain.PatientProgramMapper = function () {
    this.map = function (patientProgram, programAttributeTypes, dateCompleted) {
        ...
        return {
            dateEnrolled: moment(Bahmni.Common.Util.DateUtil.getDateWithoutTimeInReport(patientProgram.dateEnrolled)).format(Bahmni.Common.Constants.ServerDateTimeFormat),
