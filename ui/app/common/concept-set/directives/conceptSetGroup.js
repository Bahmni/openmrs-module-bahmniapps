    ...
    return {
        ...
        template: '<div ng-repeat="conceptSet in conceptSets" class="concept-set-group">' +
                    '<div ng-click="conceptSet.toggle()" ng-if="conceptSet.isAvailable(context)" class="concept-set-title">' +
                        ...
                        '</legend>' +
                    '</div>' +
                    '<concept-set ng-if="conceptSet.isLoaded" ng-show="conceptSet.isOpen" concept-set-name="conceptSet.options.conceptName" observations="observations" show-title="false" validation-handler="validationHandler"></concept-set>' +
                  '</div>'
    }
});