            ...
            template: '<div class="split-button" bm-pop-over>'+
                        ...
                        '<ul class="options">' +
                            '<li class="primaryOption">' +
                                '<button class="buttonClass" ng-click="optionClick()(primaryOption)" accesskey="{{primaryOption.shortcutKey}}" ng-disabled="optionDisabled" ng-bind-html="optionText()(primaryOption) | translate "></button>' +
                            '</li>' +
