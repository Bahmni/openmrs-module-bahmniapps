	...
	return {
		template: '<ul>' +
					    '<li ng-repeat="backLink in backLinks">' +
					        ...
					        '<a class="back-btn" ng-if="backLink.url" accesskey="{{backLink.accessKey}}" ng-href="{{backLink.url}}" id="{{backLink.id}}"> <span ng-bind-html="backLink.label"></span> </a>' +
					        '<a class="back-btn" ng-if="backLink.state" accesskey="{{backLink.accessKey}}" ui-sref="{{backLink.state}}" id="{{backLink.id}}"> <span ng-bind-html="backLink.label"></span> </a>' +
					    '</li>' +
					'</ul>',
