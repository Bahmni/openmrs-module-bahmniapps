Bahmni.Clinical.VisitSummary = (function(){
    var DateUtil = Bahmni.Common.Util.DateUtil;
    var VisitSummary = function (visitStartDateTime, mostRecentEncounterDateTime, diagnoses, dispositions, encounterTransactions, labTestOrderObsMap) {
    ...
    VisitSummary.prototype = {
        ...
        numberOfDosageDaysForDrugOrder: function (drugOrder) {
            return Bahmni.Common.Util.DateUtil.diffInDays(DateUtil.parse(drugOrder.endDate), DateUtil.parse(drugOrder.startDate));
        }
    }

    VisitSummary.create = function (encounterTransactions, orderTypes) {
        var diagnoses = [];
        var dispositions = [];
        ...
        if (encounterTransactions.length > 0) {
            ...
            mostRecentEncounterDateTime = DateUtil.parse(mostRecentEncounter.encounterDateTime);
