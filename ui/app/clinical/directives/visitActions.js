angular.module('bahmni.clinical')
    .directive('visitActions', [function () {
        var controller = function ($scope, printer) {
            var actions = {
                ...
                printVisitSummary: function () {
                    ...
                    $scope.act = function () {
                        printer.print('views/visitSummaryPrint.html', {visit: $scope.visit, patient: $scope.patient});
                    };
                }
            };
        ...
        return {
            ...
            template: '<button type="button" ng-if="visit.hasAdmissionEncounter()" ng-click="act()">{{title}}</button>'
        }
    }])
;