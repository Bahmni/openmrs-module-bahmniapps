module.exports = function (config) {
    config.set({
        ...
        exclude:[
            ...
            'app/common/app-framework/offline/android/*.js',
            'app/common/orders/offline/android/*.js',
            'app/common/patient/offline/android/*.js',
            'app/common/domain/offline/android/*.js',
            ...
            'test/unit/common/app-framework/offline/android/*.js',
            'test/unit/common/domain/offline/android/*.js',
