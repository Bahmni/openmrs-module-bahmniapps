...
describe('configurationService', function () {
    ...
    it('should fetch dosageInstructionConfig from  offline db', function (done) {
        ...
        androidDbService.getReferenceData.and.returnValue(specUtil.respondWithPromise($q, dosageInstructionConfig));
    ...
    it('should fetch stoppedOrderReasonConfig from  offline db', function (done) {
        ...
        androidDbService.getReferenceData.and.returnValue(specUtil.respondWithPromise($q, stoppedOrderReasonConfig));
    ...
    it('should fetch identifierTypesConfig from offline db', function (done) {
        ...
        androidDbService.getReferenceData.and.returnValue(specUtil.respondWithPromise($q, identifierTypesConfig));
    ...
    it('should fetch genderMap from offline db', function (done) {
        ...
        androidDbService.getReferenceData.and.returnValue(specUtil.respondWithPromise($q, genderMap));
