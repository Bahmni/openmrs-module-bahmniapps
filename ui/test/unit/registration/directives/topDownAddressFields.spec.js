...
describe('TopDownAddressFieldsDirectiveController', function () {
    ...
    describe("On autocomplete", function () {

        it("should find parent field for current search field", function () {
            var field = "cityVillage";
            expect(scope.findParentField(field)).toBe("address3");
        });
    });
