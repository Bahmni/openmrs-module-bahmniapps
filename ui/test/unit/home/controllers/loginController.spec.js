...
describe('loginController', function () {
    ...
    beforeEach(function () {
        ...
        sessionService = jasmine.createSpyObj('sessionService', ['loginUser', 'loadCredentials', 'updateSessionLocation']);
        ...
        sessionService.updateSessionLocation.and.returnValue(specUtil.simplePromise());
