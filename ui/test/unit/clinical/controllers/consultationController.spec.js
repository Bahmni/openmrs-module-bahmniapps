...
describe("ConsultationController", function () {
        ...
        appDescriptor = {
            ...
            getConfigValue: function (value) {
                if(value === 'adtNavigationConfig') {
                    return {forwardUrl: "../bed-management/#/bedManagement/patient/{{patientUuid}}/visit/{{visitUuid}}", "privilege": "app:adt"};
                }
                return true;
            }
        };
    ...
    describe("init", function () {
        ...
        it("should get ipd configuration from config", function () {
            ...
            scope.adtNavigationConfig = {forwardUrl: "../bed-management/#/bedManagement/patient/{{patientUuid}}/visit/{{visitUuid}}"};
            appService.getAppDescriptor.and.returnValue(appDescriptor);
            createController();
            expect(scope.adtNavigationConfig.forwardUrl).toEqual("../bed-management/#/bedManagement/patient/{{patientUuid}}/visit/{{visitUuid}}");
        });
    });
    ...
    it("should generate the URL as mentioned in the config", function () {
        ...
        expect(scope.adtNavigationURL()).toEqual("../bed-management/#/bedManagement/patient/{{patientUuid}}/visit/{{visitUuid}}");
    });
