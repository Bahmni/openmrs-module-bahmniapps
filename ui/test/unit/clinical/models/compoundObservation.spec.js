...
describe("CompoundObservation", function () {
    ...
    describe("listView", function () {
        it("gets leaf level observations as an array", function () {
            var observations = [
                {
                    "concept": {
                        "uuid": "2fbc945b-af3e-11e3-a5d1-0800271c1b75",
            ...
            var observationList = new Bahmni.Clinical.CompoundObservation(observations).list;
            expect(observationThatMatches("Temperature", 30, false, observationList)).toBe(true);
            expect(observationThatMatches("Systolic", 52, true, observationList)).toBe(true);
        });
    });
});
