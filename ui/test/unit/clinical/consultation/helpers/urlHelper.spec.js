...
describe("url helper", function () {
    ...
    it("should return patient url", function(){
    	...
    	var expectedUrl = '/patient/{0}'.format(stateParams.patientUuid);
    ...
    it("should return consultation url", function(){
    	...
    	var expectedUrl = '/patient/{0}/consultation'.format(stateParams.patientUuid);
    	expect(consultationUrl).toBe(expectedUrl);
    });

    it("should return visit url", function(){
    	var visitUrl = urlHelper.getVisitUrl(visitUuid);
    	var expectedUrl = '/patient/{0}/visit/{1}'.format(stateParams.patientUuid, visitUuid);
