...
module.exports = function (grunt) {
  ...
  // configurable paths
    ...
    var libraryJSFiles = [
        ...
        "components/bdsec-form-controls/helpers.js",
        "components/bdsec-form-controls/bundle.js",
                ...
                files: [
                    {
                        expand: true,
                        dot: true,
                        cwd: "<%= yeoman.nodeModules %>/bdsec-form-controls/dist",
                        dest: "<%= yeoman.app %>/components/bdsec-form-controls/",
                        src: ["*.*"]
                    },
                    {
                        expand: true,
