...
describe('FormDisplayControl Component with Accordion and Non-Accordion', () => {
  ...
  it('should render accordion form entries when loading is done', async () => {
    ...
    await waitFor(() => {
      ...
      expect(container.querySelector(".row-accordion > .form-name-text > .form-link").innerHTML).toEqual(moment(1693217959000).format("DD MMM YY h:mm a"));
  ...
  it('should render non-accordion form entries when loading is done', async () => {
    ...
    await waitFor(() => {
      ...
      expect(container.querySelectorAll(".form-non-accordion-text.form-date-align > a")[0].innerHTML).toEqual(moment(1693277657000).format("DD MMM YY h:mm a"));
      ...
      expect(container.querySelectorAll(".form-non-accordion-text.form-date-align > a")[1].innerHTML).toEqual(moment(1693277657000).format("DD MMM YY h:mm a"));
