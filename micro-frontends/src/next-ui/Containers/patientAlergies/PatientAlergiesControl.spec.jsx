...
describe("PatientAlergiesControl", () => {
  it("renders loading message when isLoading is true", () => {
    render(<IntlProvider locale="en"><PatientAlergiesControl hostData={testHostData} appService={mockAppService}/></IntlProvider>);
  ...
  it("renders allergies section with Add button when active visit", async () => {
    const { container } = render(
      <IntlProvider locale="en"><PatientAlergiesControl hostData={testHostData} appService={mockAppService}/></IntlProvider>
    );
  ...
  it("renders allergies section without Add button when it is not active visit", async () => {
    const { container } = render(
      <IntlProvider locale="en"><PatientAlergiesControl hostData={testHostDataWithoutActiveVisit} appService={mockAppService}/></IntlProvider>
    );
