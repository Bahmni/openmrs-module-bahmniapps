...
it("should make axios call with the correct url", () => {
    ...
    expect(axios.get).toHaveBeenCalledWith("/openmrs/ws/rest/v1/concept/allergen_uuid?v=full&locale=en");
    fetchAllergensOrReactions("reaction_uuid");
    expect(axios.get).toHaveBeenCalledWith("/openmrs/ws/rest/v1/concept/reaction_uuid?v=full&locale=en");
