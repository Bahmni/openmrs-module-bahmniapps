    ...
    grunt.initConfig({
        ...
        usemin: {
            html: [
                ...
                '<%= yeoman.dist %>/bed-managementt/**/*.html',
        ...
        rename: {
            minified: {
                files: [
                    ...
                    {expand: true, cwd: '<%= yeoman.dist %>', src: ['bed-management.min.js'], dest: '<%= yeoman.dist %>/orders/'},
                    ...
                    {expand: true, cwd: '<%= yeoman.dist %>', src: ['bed-management.min.css'], dest: '<%= yeoman.dist %>/orders/'},
