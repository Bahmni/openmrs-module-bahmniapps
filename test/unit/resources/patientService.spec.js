...
describe('Patient resource', function () {
    ...
    beforeEach(module('resources.patientService'));
    beforeEach(module(function ($provide) {
        $provide.value('$http', mockHttp);
        $provide.value('$rootScope', rootScope);
    }));

    it('Should call url for search', inject(['patientService', function (patientService) {
    ...
    it('Should create a patient', inject(['patientService', function (patientService) {
        var baseUrl = 'http://blah.com';
        rootScope.BaseUrl = baseUrl;
        var patientJson = {
            "gender": "Male",
